...
@Service
public class SearchDocumentsByLeadIdDataProvider implements SearchDocumentsByLeadIdGateway {
    ...
    @Override
    public Page<Document> execute(final Long leadId, final Integer pageNumber, final Integer size, final String orderBy) {
        ...
        final org.springframework.data.domain.Page<DocumentEntity> page = documentRepository.findByLeadId(leadId, entityGraph, pageRequest);
