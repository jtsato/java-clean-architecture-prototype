...
@Service
public class SearchBooksByAuthorAKeyDataProvider implements SearchBooksByAuthorAKeyGateway {
    ...
    @Override
    public Page<Book> execute(final Long authorAKey, final Integer pageNumber, final Integer size, final String orderBy) {
        ...
        final org.springframework.data.domain.Page<BookEntity> page = bookRepository.findByAuthorAKey(authorAKey, entityGraph, pageRequest);
