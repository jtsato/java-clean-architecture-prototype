...
@Transactional
@Service
public class UpdateAuthorByAaKeyDataProvider implements UpdateAuthorByAaKeyGateway {
    ...
    public Optional<Author> execute(final Author author) {
        ...
        final Optional<AuthorEntity> optional = authorRepository.findByAaKey(author.getAaKey());
