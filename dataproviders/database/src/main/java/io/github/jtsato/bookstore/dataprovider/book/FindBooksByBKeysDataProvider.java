...
@Service
public class FindBooksByBKeysDataProvider implements FindBooksByBKeysGateway {
    ...
    public Page<Book> execute(final List<Long> bKeys) {
        ...
        final BooleanExpression predicate = QBookEntity.bookEntity.bKey.in(bKeys);
        final PageRequest pageRequest = PageRequestHelper.buildPageRequest(0, 1000, "bKey:asc");
