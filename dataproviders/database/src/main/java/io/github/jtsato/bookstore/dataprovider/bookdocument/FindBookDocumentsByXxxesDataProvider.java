...
@Service
public class FindBookDocumentsByXxxesDataProvider implements FindBookDocumentsByXxxesGateway {
    ...
    public Page<BookDocument> execute(final List<Long> xxxes) {
        ...
        final BooleanExpression predicate = QBookDocumentEntity.bookDocumentEntity.xxx.in(xxxes);
        final PageRequest pageRequest = PageRequestHelper.buildPageRequest(0, 1000, "xxx:asc");
