...
@Service
public class SearchBookDocumentsByBookBbKeyDataProvider implements SearchBookDocumentsByBookBbKeyGateway {
    ...
    @Override
    public Page<BookDocument> execute(final Long bookBbKey, final Integer pageNumber, final Integer size, final String orderBy) {
        ...
        final org.springframework.data.domain.Page<BookDocumentEntity> page = bookDocumentRepository.findByBookBbKey(bookBbKey, entityGraph, pageRequest);
