...
@Service
public class FindAuthorsByAaKeysDataProvider implements FindAuthorsByAaKeysGateway {
    ...
    public Page<Author> execute(final List<Long> aaKeys) {
        ...
        final BooleanExpression predicate = QAuthorEntity.authorEntity.aaKey.in(aaKeys);
        final PageRequest pageRequest = PageRequestHelper.buildPageRequest(0, 1000, "aaKey:asc");
