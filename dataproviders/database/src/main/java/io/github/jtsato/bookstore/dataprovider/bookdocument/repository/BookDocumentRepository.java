...
public interface BookDocumentRepository extends EntityGraphJpaRepository<BookDocumentEntity, Long>, EntityGraphQuerydslPredicateExecutor<BookDocumentEntity> {
    ...
    Page<BookDocumentEntity> findByBookId(final Long bookId, final EntityGraph entityGraph, final PageRequest pageRequest);

    Optional<BookDocumentEntity> findBySize(final Long size, final EntityGraph entityGraph);
