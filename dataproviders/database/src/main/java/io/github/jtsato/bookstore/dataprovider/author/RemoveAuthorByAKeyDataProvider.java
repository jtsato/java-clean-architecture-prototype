...
@Transactional
@Service
public class RemoveAuthorByAKeyDataProvider implements RemoveAuthorByAKeyGateway {
    ...
    @Override
    public Optional<Author> execute(final Long aKey) {

        final Optional<AuthorEntity> optional = authorRepository.findByAKey(aKey);
