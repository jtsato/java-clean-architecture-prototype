...
@Service
public class SearchBookDocumentsByBookIdDataProvider implements SearchBookDocumentsByBookIdGateway {
    ...
    @Override
    public Page<BookDocument> execute(final Long bookId, final Integer pageNumber, final Integer size, final String orderBy) {
        ...
        final org.springframework.data.domain.Page<BookDocumentEntity> page = bookDocumentRepository.findByBookId(bookId, entityGraph, pageRequest);
