...
@FunctionalInterface
public interface FindDocumentTypesByIdsApiMethod {

    @Operation(summary = "Find DocumentTypes by Ids")
    ...
    FindDocumentTypesByIdsWrapperResponse execute(final FindDocumentTypesByIdsRequest request);
}
