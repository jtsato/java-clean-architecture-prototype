...
@Tag(name = "Addresses")
@FunctionalInterface
public interface UpdateAddressByIdApiMethod {
    ...
    UpdateAddressByIdResponse execute(@Parameter(description = "Address Id") final Long id, final UpdateAddressByIdRequest request);
}
