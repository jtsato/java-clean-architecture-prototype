...
@Tag(name = "Customers")
@FunctionalInterface
public interface UpdateCustomerByIdApiMethod {
    ...
    UpdateCustomerByIdResponse execute(@Parameter(description = "Customer Id") final Long id, final UpdateCustomerByIdRequest request);
}
