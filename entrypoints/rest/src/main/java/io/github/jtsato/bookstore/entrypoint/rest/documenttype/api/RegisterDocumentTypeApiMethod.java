...
@FunctionalInterface
public interface RegisterDocumentTypeApiMethod {

    @Operation(summary = "Register new DocumentType")
    ...
    RegisterDocumentTypeResponse execute(final RegisterDocumentTypeRequest request);
}
