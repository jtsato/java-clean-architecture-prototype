...
@FunctionalInterface
public interface UpdateJobInformationByIdApiMethod {

    @Operation(summary = "Update JobInformation by Id")
    ...
    UpdateJobInformationByIdResponse execute(@Parameter(description = "JobInformation Id") final Long id, final UpdateJobInformationByIdRequest request);
}
