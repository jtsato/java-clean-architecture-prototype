...
@Tag(name = "Files")
@FunctionalInterface
public interface UpdateFileByIdApiMethod {
    ...
    UpdateFileByIdResponse execute(@Parameter(description = "File Id") final Long id, final UpdateFileByIdRequest request);
}
