...
public interface SearchBooksApiMethod {
    ...
    @Parameter(in = ParameterIn.QUERY,
               name = "available",
               description = "If TRUE, retrieve only the available Books; if FALSE, the opposite.",
    ...
    SearchBooksWrapperResponse execute(@Parameter(hidden = true) final Pageable pageable, @Parameter(hidden = true) final SearchBooksRequest request);
}
