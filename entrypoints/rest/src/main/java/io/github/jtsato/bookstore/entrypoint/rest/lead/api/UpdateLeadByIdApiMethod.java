...
@Tag(name = "Leads")
@FunctionalInterface
public interface UpdateLeadByIdApiMethod {
    ...
    UpdateLeadByIdResponse execute(@Parameter(description = "Lead Id") final Long id, final UpdateLeadByIdRequest request);
}
