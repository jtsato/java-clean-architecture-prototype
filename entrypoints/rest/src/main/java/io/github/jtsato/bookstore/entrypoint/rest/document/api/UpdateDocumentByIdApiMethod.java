...
@Tag(name = "Documents")
@FunctionalInterface
public interface UpdateDocumentByIdApiMethod {
    ...
    UpdateDocumentByIdResponse execute(@Parameter(description = "Document Id") final Long id, final UpdateDocumentByIdRequest request);
}
