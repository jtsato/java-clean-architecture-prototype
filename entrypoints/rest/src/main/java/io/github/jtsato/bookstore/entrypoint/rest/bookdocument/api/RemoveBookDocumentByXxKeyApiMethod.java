...
@FunctionalInterface
public interface RemoveBookDocumentByXxKeyApiMethod {

    @Operation(summary = "Remove BookDocument by XxKey")
    ...
    void execute(@Parameter(description = "BookDocument XxKey") final Long xxKey);
}
