...
@FunctionalInterface
public interface RegisterBookDocumentApiMethod {

    @Operation(summary = "Register new BookDocument")
    ...
    RegisterBookDocumentResponse execute(final RegisterBookDocumentRequest request);
}
