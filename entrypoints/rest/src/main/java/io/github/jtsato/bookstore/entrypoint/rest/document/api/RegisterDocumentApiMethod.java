...
@Tag(name = "Documents")
@FunctionalInterface
public interface RegisterDocumentApiMethod {

    @Operation(summary = "Register new Document")
    ...
    RegisterDocumentResponse execute(final RegisterDocumentRequest request);
}
