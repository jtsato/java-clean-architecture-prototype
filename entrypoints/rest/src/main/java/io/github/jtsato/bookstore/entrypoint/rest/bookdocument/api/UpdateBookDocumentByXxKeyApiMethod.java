...
@FunctionalInterface
public interface UpdateBookDocumentByXxKeyApiMethod {

    @Operation(summary = "Update BookDocument by XxKey")
    ...
    UpdateBookDocumentByXxKeyResponse execute(@Parameter(description = "BookDocument XxKey") final Long xxKey, final UpdateBookDocumentByXxKeyRequest request);
}
