...
@Tag(name = "Addresses")
@FunctionalInterface
public interface FindAddressesByIdsApiMethod {

    @Operation(summary = "Find Addresses by Ids")
    ...
    FindAddressesByIdsWrapperResponse execute(final FindAddressesByIdsRequest request);
}
