...
@FunctionalInterface
public interface FindJobInformationsByIdsApiMethod {

    @Operation(summary = "Find JobInformations by Ids")
    ...
    FindJobInformationsByIdsWrapperResponse execute(final FindJobInformationsByIdsRequest request);
}
