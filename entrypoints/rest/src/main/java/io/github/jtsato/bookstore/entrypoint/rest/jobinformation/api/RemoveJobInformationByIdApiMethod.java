...
@FunctionalInterface
public interface RemoveJobInformationByIdApiMethod {

    @Operation(summary = "Remove JobInformation by Id")
    ...
    void execute(@Parameter(description = "JobInformation Id") final Long id);
}
