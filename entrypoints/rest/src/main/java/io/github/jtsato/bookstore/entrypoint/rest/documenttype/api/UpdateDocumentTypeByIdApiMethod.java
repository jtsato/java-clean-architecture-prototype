...
@FunctionalInterface
public interface UpdateDocumentTypeByIdApiMethod {

    @Operation(summary = "Update DocumentType by Id")
    ...
    UpdateDocumentTypeByIdResponse execute(@Parameter(description = "DocumentType Id") final Long id, final UpdateDocumentTypeByIdRequest request);
}
