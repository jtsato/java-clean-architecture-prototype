...
import io.github.jtsato.bookstore.entrypoint.rest.address.domain.response.UpdateAddressByIdLeadResponse;
...
public final class UpdateAddressByIdPresenter {


    public static UpdateAddressByIdResponse of(final Address address) {
        return new UpdateAddressByIdResponse(address.getId(),
                                          of(address.getLead()),
                                             address.getZipCode(),
                                             address.getCity(),
                                             address.getState(),
    ...
    public static UpdateAddressByIdLeadResponse of(final Lead lead) {
        return new UpdateAddressByIdLeadResponse(lead.getId(),
                                                 lead.getSelfiePhoto(),
                                                 lead.getCpf(),
                                                 lead.getCellphone(),
                                                 lead.getName(),
