...
@FunctionalInterface
public interface RemoveDocumentTypeByIdApiMethod {

    @Operation(summary = "Remove DocumentType by Id")
    ...
    void execute(@Parameter(description = "DocumentType Id") final Long id);
}
