...
@FunctionalInterface
public interface GetDocumentTypeByIdApiMethod {

    @Operation(summary = "Get DocumentType by Id")
    ...
    GetDocumentTypeByIdResponse execute(@Parameter(description = "DocumentType Id") final Long id);
}
