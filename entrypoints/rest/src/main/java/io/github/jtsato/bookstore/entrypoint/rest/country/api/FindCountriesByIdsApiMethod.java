...
@Tag(name = "Countries")
@FunctionalInterface
public interface FindCountriesByIdsApiMethod {

    @Operation(summary = "Find Countries by Ids")
    ...
    FindCountriesByIdsResponse execute(final FindCountriesByIdsRequest findCountriesByIdsRequest);
}
