...
@Tag(name = "Documents")
@FunctionalInterface
public interface FindDocumentsByIdsApiMethod {

    @Operation(summary = "Find Documents by Ids")
    ...
    FindDocumentsByIdsWrapperResponse execute(final FindDocumentsByIdsRequest request);
}
